...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDePublicoes(db)
...
// BuscarPublicacoes traz as pubicacoes do feed do usuario
...
// BuscarPublicacao traz uma publicao do feed
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID{
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível atualizar uma publicação qunão seja sua"))
		return
	}
...
//BuscarPublicacoesPorUsuario traz todas as publicacoes de um usuário específico
